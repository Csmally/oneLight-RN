  ...
  return (
    <TouchableWithoutFeedback onPress={() => changeActiveTab(selfIndex)}>
      <Animated.View style={[styles.tabItem, categoryContainerAnimatedStyle]}>
        ...
        />
        <Animated.Text
          style={[styles.tabTitle, categoryTextColorAnimatedStyle]}
...
export default memo(CategoryItem, (prevProps, nextProps) => {
  return (
    prevProps.activeTabIndex !== nextProps.selfIndex &&
    nextProps.activeTabIndex !== nextProps.selfIndex
  );
});
